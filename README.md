...
5. Open a web browser and navigate to http://159.65.40.248/ to access the website.
6. Use the provided login form to enter the correct username and password for authentication.
7. Explore the functionality of the web application and observe the vulnerabilities associated with JWT token manipulation.
